    ...
    <body>
        <header>
            ...
            <nav class="navbar">
                <ul class="nav-links">
                    ...
                    <li><a href="allPeoples.jsp">All Peoples</a></li>
                    <li><a href="follower.jsp">Followers</a></li>
                    <li><a href="following.jsp">Followings</a></li>
                    <li><a href="message.jsp">Message</a></li>
                    <li><a href="viewMessage.jsp">View Messages</a></li>
        ...
        <main>
            <section id="welcome">
                ...
                <p>
                    Your user ID is 
                    <strong><%= (session.getAttribute("id") != null) ? session.getAttribute("id") : "N/A"%></strong>.
                </p>
            </section>
        </main>
        <footer>
